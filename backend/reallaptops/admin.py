...
@admin.register(RealLaptop)
class RealLaptopAdmin(admin.ModelAdmin):
    list_display = ("thumb", "name", "brand", "price_display", "ram_gb", "storage_gb", "display_inches", "display_type", "created_at")
